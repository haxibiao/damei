...
const ContentView = observer(() => {
    ...
    return (
        <View style={styles.content}>
                ...
                <Text style={{fontSize:14,color:'gray',marginHorizontal:15}}>开启镜像后，观众端看到的画面将和主播端看到的画面一致。如果不开启的话，因为镜像原因，观众观看到的画面和主播端看到的是相反的哦。</Text>
                <Text style={{color:'#555',marginBottom:6,marginTop:12}}>当前已：<Text style={{color: LiveBeautyStore.mirrored ? 'green' : '#333'}}>{LiveBeautyStore.mirrored ? "开启" : "关闭"}</Text></Text>
                <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                    ...
                    style={{height:28,width:70,backgroundColor:'#FFC543',justifyContent:'center',alignItems:'center',borderTopLeftRadius:6,borderBottomLeftRadius:6}}>
                    ...
                    style={{height:28,width:70,backgroundColor:'lightgray',justifyContent:'center',alignItems:'center',borderTopRightRadius:6,borderBottomRightRadius:6}}>
