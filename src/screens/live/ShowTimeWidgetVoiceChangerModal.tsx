...
const ContentView = () => {
    ...
    return (
        <View style={styles.content}>
                    ...
                    FakeVoices.map((item:{
                        ...
                        return (
                            ...
                            onPress={()=> {
                                setselected(index);
                                setapplied(false);
                            }} style={{width:ItemWidth,marginEnd:ItemGap,justifyContent:'center',alignItems:'center',marginBottom:15}}>
                                <Avatar file={item.file} size={ItemWidth*0.8} borderWidth={selected == index ? 2 : 0} borderColor={'#FFC543'} frameStyle={{justifyContent:'center',alignItems:'center'}}/>
            ...
            activeOpacity={0.85} 
            style={{width:sw * 0.4,height:30,backgroundColor:applied ? 'green' :'#FFC543',justifyContent:'center',alignItems:'center',borderRadius:5,overflow:'hidden'}}>
