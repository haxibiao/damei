...
class MakeMoenyManual extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tabs: ['新人必看', '提现问题', '贡献点问题', '账号问题', '其他问题', '有奖问答'],
            items: [
                {
                    title: '新人必看',
                    childItems: [
                ...
                },
                {
                    ...
                    childItems: [
                        ...
                        },
                        {
                            title: '如何绑定微信？',
                            content:
                                '您在登录答妹时，可以选择微信授权登录或者手机注册。或者在【我的】-【设置】-【账号安全】处进行绑定。',
                        },
                        {
                            title: '忘记密码怎么办？',
                ...
                //             content:
                //                 '1.每成功邀请一位新用户下载登录APP（并绑定手机号），您将获得600智慧点和36贡献点的奖励，您可以将活动页面通过微信、QQ、微博等方式分享给好友，同时您邀请的好友登录后也将获得新人福利智慧点奖励，邀请好友人数无上限，邀请越多奖励越多。',
                //         },
                //         {
                ...
                // },
                {
                    ...
                    childItems: [
                        ...
                        { title: '无法更新怎么办？', content: '可以到www.xiaodamei.com下载最新安装包哦' },
                    ],
                },
                {
                    title: '有奖问答',
                    childItems: [
                        {
                            title: '如何发布视频动态？',
                            content:
                                '您可以选择【创建动态】填写详细的文字描述+优质视频内容即可发布视频动态。内容保持真实客观，用语规范；不得涉黄、政治引导、煽动谣言、传播垃圾广告。',
                        },
                        {
                            title: '如何发布悬赏视频问答？',
                            content:
                                '1.您可以选择【创建动态】填写详细的问题描述+优质视频内容，在发布页下方可以选择支付不同数额的悬赏奖励提交即可，优质的悬赏问答将获得官方推荐获得更多曝光。\n2.当其他答友回答了您的问题，您可以在评论区长按您满意的答案设置为最佳答案，被采纳的用户将获得您所有的悬赏奖励。\n3.若您在发布问题后的7天内未设置最佳答案，系统将在超时后默认将悬赏奖励分发给评论区的三名用户。',
                        },
                        {
                            title: '什么的回答才能获得悬赏智奖励？',
                            content:
                                '回答可以中肯客观、直接或新颖、脑洞大开，有用并有趣的回答会更有机会被采纳。被采纳的答案将获得一定智慧点奖励。',
                        },
                    ],
                },
            ],
