...
class index extends Component {
	...
	render() {
		...
		const { user, navigation, login } = this.props;
		return (
			<Query query={UserQuery} variables={{ id: user.id }} skip={!login}>
							...
							<View style={styles.container}>
								<View style={styles.walletPanel}>
									<View style={styles.accumulat}>
										...
										<View style={styles.accumulated}>
											<Text style={styles.greyText1}>累计收益(元)</Text>
											<Text style={styles.boldBlackText}>
												{user.wallet.total_withdraw_amount || 0}
											</Text>
										</View>
									</View>
