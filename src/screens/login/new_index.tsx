...
import { observer, Storage } from '../../data';
...
const LoginInputForm = React.memo(
    observer((props: { navigation: any }) => {
...
const index = (props: any) => {
    return (
        <Page.PageCleared containerStyle={{ alignItems: 'center' }} safe enableBack>
            <Avatar
                file={require('../../../icon.png')}
                size={sw * 0.3}
                frameStyle={{ marginTop: sh * 0.12, marginBottom: sh * 0.06 }}
            />
