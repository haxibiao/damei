...
import { Theme, PxFit, Config, SCREEN_WIDTH, SCREEN_HEIGHT, Tools } from 'utils';
...
class index extends Component {
    ...
    showShareType = () => {
        ...
        const shareTypeOverlayView = (
            <Overlay.PullView style={{ flexDirection: 'column', justifyContent: 'flex-end' }} animated>
                <ShareTypeOverlay hide={() => Overlay.hide(this.ShareTypeOverlayKey)} user={user} />
            </Overlay.PullView>
        );
        this.ShareTypeOverlayKey = Overlay.show(shareTypeOverlayView);
    };
    ...
    showShareGuide = () => {
        ...
        const shareGuideOverlayView = (
            <Overlay.View animated>
                <View style={styles.overlayInner}>
                    <ShareGuide hide={() => Overlay.hide(this.ShareGuideOverlayKey)} user={user} />
                </View>
            </Overlay.View>
        );
        this.ShareGuideOverlayKey = Overlay.show(shareGuideOverlayView);
    };
}
