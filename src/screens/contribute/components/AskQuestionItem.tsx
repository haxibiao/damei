...
const AskQuestionItem = (props: Props) => {
    ...
    const navigationAction = () => {
        ...
        } else if (question.form !== 0 && activeIndex) {
            props.navigation.navigate('VideoPost', { questions, index: activeIndex });
        } else if (question.form !== 0 && !activeIndex) {
            props.navigation.navigate('VideoPost', { questions: [question] });
        }
    };
