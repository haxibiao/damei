                        ...
                        <View style={{ marginTop: PxFit(30) }}>
                            ...
                            <View style={{ paddingHorizontal: PxFit(20) }}>
                                ...
                                <Text style={styles.appIntro}>
                                    ...
                                    只要你能答对就能赚取相应报酬，快来{Config.AppName}试试身手吧。
                                </Text>
                            </View>
                            ...
                            <View style={{ marginTop: PxFit(30) }}>
                                <View style={{ paddingHorizontal: PxFit(20) }}>
                                    ...
                                    <Text style={styles.officialText}>官网地址： xiaodamei.com</Text>
                                    <Text style={styles.officialText}>商务合作： db@xiaodamei.com</Text>
                                    <Text style={styles.officialText}>新浪微博： 答妹APP</Text>
                                    <Text style={styles.officialText}>微信公众号：答妹APP</Text>
                                    <Text style={styles.officialText}>官方QQ群： 519397680</Text>
                                </View>
                            </View>
                        </View>
                        <View style={styles.copyright}>
                            <Text>近邻乐(深圳)有限责任公司</Text>
                            <Text>www.xiaodamei.com</Text>
                        </View>
                    </View>
                </ScrollView>
            </PageContainer>
